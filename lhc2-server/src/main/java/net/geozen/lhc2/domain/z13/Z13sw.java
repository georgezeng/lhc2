package net.geozen.lhc2.domain.z13;
...
@Entity
@Table(name = "z13sw")
public class Z13sw extends PosBaseEntity {
	private int sw1Pos;
	private int sw2Pos;
	private int sw3Pos;
	private int sw4Pos;
	...
	public int getSw6Pos() {
		return sw6Pos;
	}

	public void setSw6Pos(int sw6Pos) {
		this.sw6Pos = sw6Pos;
	}

	public int getSw7Pos() {
		return sw7Pos;
	}

	public void setSw7Pos(int sw7Pos) {
		this.sw7Pos = sw7Pos;
	}

	public int getSw8Pos() {
		return sw8Pos;
	}

	public void setSw8Pos(int sw8Pos) {
		this.sw8Pos = sw8Pos;
	}

	public int getSw9Pos() {
		return sw9Pos;
	}

	public void setSw9Pos(int sw9Pos) {
		this.sw9Pos = sw9Pos;
	}

	public int getSw10Pos() {
		return sw10Pos;
	}

	public void setSw10Pos(int sw10Pos) {
		this.sw10Pos = sw10Pos;
	}

	public int getSw11Pos() {
		return sw11Pos;
	}

	public void setSw11Pos(int sw11Pos) {
		this.sw11Pos = sw11Pos;
	}

	public int getSw12Pos() {
		return sw12Pos;
	}

	public void setSw12Pos(int sw12Pos) {
		this.sw12Pos = sw12Pos;
	}

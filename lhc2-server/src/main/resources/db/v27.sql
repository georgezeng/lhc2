...
CREATE TABLE `slqzssw` (
	...
	`sw13pos` int(11) NOT NULL,
	`sw14pos` int(11) NOT NULL,
	`sw15pos` int(11) NOT NULL,
	`sw16pos` int(11) NOT NULL,
	PRIMARY KEY (`id`)
);
